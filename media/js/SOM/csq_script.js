...
function generate(tableID){
    ...
    cell2.innerHTML = "<input type='text' id='buyerCode-"+num+"' name='buyerCode-"+num+"' class='colorCode' value='"+bcode+"'/>";
...
// 			}
			...
			//alert("statusSize "+statusSize);
			
			if(statusSize=="change" || statusSize=="new") {
				//alert("here 123"+statusSize);
