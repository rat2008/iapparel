...
class PHPExcel_Shared_Date
{
	...
	public static function PHPToExcel($dateValue = 0, $adjustToTimezone = FALSE, $timezone = NULL) {
		// $saveTimeZone = date_default_timezone_get(); // comment by ckwai on 20022020
		// date_default_timezone_set('UTC'); // comment by ckwai on 20022020
		$retValue = FALSE;
		...
		// date_default_timezone_set($saveTimeZone); // comment by ckwai on 20022020
