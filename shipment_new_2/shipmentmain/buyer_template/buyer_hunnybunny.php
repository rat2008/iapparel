...
$html .= '<table cellspacing="1" cellpadding="3" border="0" class="tb_joefresh">
				<tr>
					<th style="width:15%" align="center">ACTUAL SHIP DATE <br/>'.$shippeddate.'</th>
					<th style="width:7%" align="center">NO. OF PKGS</th>
					<th style="width:51%" align="center" colspan="3">DESCRIPTION</th>
	...
	foreach($arr_fabric as $key => $arr_info){
			...
			$html .= '<td>STYLE NO.</td>';
			$html .= '<td class="right_border">Color</td>';
			$html .= '<td class="left_border right_border"></td>';
			$html .= '<td class="left_border right_border"></td>';
			$html .= '<td class="left_border right_border"></td>';
			$html .= '</tr>';
...
$pdf->SetFont('arialuni', '', 5, '', false); //heavy
